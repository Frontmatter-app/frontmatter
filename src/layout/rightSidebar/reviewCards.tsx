...
export const reviewCardClass = (active = false, accent = "border-black/10 dark:border-white/10") =>
  cn("p-3 rounded-lg border transition-colors flex flex-col gap-2.5 cursor-pointer bg-[var(--editor-secondary-bg)]",
    active ? cn("bg-[var(--editor-bg-color)] shadow-sm", accent) : cn(accent, "hover:bg-[var(--editor-bg-color)] hover:border-black/10 dark:hover:border-white/10"));
